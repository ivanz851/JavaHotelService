...
```
cd existing_repo
git remote add origin https://gitlab.com/test6902136/javahotelservice.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/test6902136/javahotelservice/-/settings/integrations)
